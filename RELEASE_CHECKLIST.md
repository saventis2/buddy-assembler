...
- [x] PR-07 exported build: launches outside editor; writable saves;
...
- [x] Exported Windows build (signed or signing-decision documented —
      V1 ships unsigned per `docs/product/PACKAGING.md`).
- [x] `SHA256SUMS` for release artifacts (generated by CI after PR-07).
